...
#include <mpif.h>
          ...
          if (masterproc) then
              ...
              ret = nf_inq_varid (ncid_input, "ts", tsid)!3d temperature
              ...
              !ret = nf_get_var_real (ncid_input, ssfid, ssf)
...
#include <mpif.h>
          ...
          call mpi_bcast(timelen, 1, mpi_integer, 0, mpicom, ier)
          call mpi_bcast(levlen, 1, mpi_integer, 0, mpicom, ier)
